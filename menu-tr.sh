...
echo -e " ${WH}[${COLOR1}03${WH}]$NC ${COLOR1}•${WH}Check User Login XRAY Trojan WS\033[0m"
echo -e " ${WH}[${COLOR1}04${WH}]$NC ${COLOR1}•${WH}Delete XRAY Trojan WS Account\033[0m"
echo -e " ${WH}[${COLOR1}05${WH}]$NC ${COLOR1}•${WH}Renew XRAY Trojan WS Account\033[0m"
echo -e " ${WH}[${COLOR1}06${WH}]$NC ${COLOR1}•${WH}Check XRAY Trojan WS Config\033[0m"
