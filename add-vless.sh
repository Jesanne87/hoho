...
until [[ $user =~ ^[a-zA-Z0-9_]+$ && ${CLIENT_EXISTS} == '0' ]]; do
        ...
        echo -e " $COLOR1║          ${WH}Add XRAY Vless WS Account         $COLOR1║\033[0m"
        echo -e " $COLOR1╚════════════════════════════════════════════╝\033[0m"
...
clear
		     echo -e " $COLOR1╔════════════════════════════════════════════╗\033[0m"
            echo -e " $COLOR1║     ${WH}Add XRAY Vless Account       $COLOR1║\033[0m"
            echo -e " $COLOR1╚════════════════════════════════════════════╝\033[0m"
			echo ""
...
clear
echo -e ""
echo -e " $COLOR1❦═══════════════════${NC}$WH[${bold}Xray Vless ws]$COLOR1═══════════════════❦${NC}"
echo -e ""
echo -e " Remarks           : ${user}"
